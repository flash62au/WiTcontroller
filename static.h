...
// *******************************************************************************************************************
   ...
   #define USE_WIFI_COUNTRY_CODE false
#endif
#ifndef COUNTRY_CODE
...
const int glyph_guest_mode = 0x00ca;
...
// *******************************************************************************************************************
  ...
  #define AUTO_CONNECT_TO_FIRST_WITHROTTLE_SERVER false
#endif
...
#ifndef MAX_FUNCTION_SEARCH
   #define MAX_FUNCTION_SEARCH 4
#endif

#ifndef FUNCTION_SEARCH_LABELS
   #define FUNCTION_SEARCH_LABELS      { {"Horn","Whistle"}, {"Horn",""}, {"Whistle",""}, {"Brake",""} }
#endif

#ifndef FUNCTION_SEARCH_IDS
   #define FUNCTION_SEARCH_IDS {HORN_OR_WHISTLE_SEARCH, HORN_SEARCH, WHISTLE_SEARCH, BRAKE_SEARCH} 
#endif

#ifndef FUNCTION_SEARCH_RANDOM_MATCH
   #define FUNCTION_SEARCH_RANDOM_MATCH false
#endif

// ***************************************************
// guest mode

#ifndef GUEST_MODE_ENABLED
   #define GUEST_MODE_ENABLED false
#endif

#ifndef GUEST_MODE_PIN_1
   #define GUEST_MODE_PIN_1 41
#endif

#ifndef GUEST_MODE_PIN_2
   #define GUEST_MODE_PIN_2 42
#endif

#ifndef GUEST_MODE_LED_PIN
   #define GUEST_MODE_LED_PIN -1
#endif

#ifndef GUEST_MODE_HOLD_DURATION
