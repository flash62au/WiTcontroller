...
- Provides a list of discovered SSIDs with the ability to choose one. When you select one:
  ...
  - If it is a DCC-EX EX-CommandStation in Access Point (AP) mode, it will try to guess the password. <br /> *Warning!* It assumes the it will be the default password. If you have changed the password it will fail to connect.  (I am looking at a solution for this situation.)
