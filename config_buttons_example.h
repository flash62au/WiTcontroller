...
// *******************************************************************************************************************
// Throttle Pot
// To use a pot instead of the rotary encode, uncomment the follow lines
//
// Set the number of notches and the values of the pot at each notch.  must be 8 values
// Numbers can generated by Generate_Throttle__Brake__Reverser__Numbers program by Sumner
